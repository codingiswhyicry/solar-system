...
var earth = UIImageView(frame: CGRect(x: mainSpace.frame.height /  2, y: mainSpace.frame.size.width / 2 - 230, width: 35 , height: 35))
...
earth.orbit(view: earth, center: mainSpace, radius: 230, time: 3.0/*4.0*/)
earth.rotation(view: earth)
mainSpace.addSubview(mars)
mars.orbit(view: mars, center: mainSpace, radius: 280, time: 4.0/*6.0*/)
mainSpace.addSubview(jupiter)
jupiter.orbit(view: jupiter, center: mainSpace, radius: 390, time: 5.0)//8.00)
mainSpace.addSubview(saturn)
saturn.orbit(view: saturn, center: mainSpace, radius: 480, time: 6.0)//10.0)
mainSpace.addSubview(uranus)
uranus.orbit(view: uranus, center: mainSpace, radius: 540, time: 7.0)//13.0)
mainSpace.addSubview(neptune)
neptune.orbit(view: neptune, center: mainSpace, radius: 600, time: 8.0)//14.0)
mainSpace.addSubview(pluto)
pluto.orbit(view: pluto, center: mainSpace, radius: 650, time: 9.0)//20.0)
